...
- Python 3.10+ (mypy --strict) + httpx, Pydantic v2, pandas, Typer, Rich, Hypothesis, mutmut; vendored rrweb analyzer (pure stdlib); optional pm4py (replay-mining), tslearn (replay-ml), networkx + anytree (replay-all) (044-session-replay)
